            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                 @if ($errors->any())
                        ...
                        @endif
              <form action="{{route('manager-category.store')}}" method="POST" id="quickForm" enctype="multipart/form-data">
              @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="slug">Tên danh mục (<span class="required">*</span>):</label>
                    <input type="text" name="name_category" onkeyup="ChangeToSlug()" class="form-control" id="slug" value="{{old('name_category')}}" placeholder="Name Of Category">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <select class="custom-select" name="active">
                      <option <?php echo old('active')==1? "selected" : ""?> value="1">Kích hoạt</option>
                      <option <?php echo old('active')==0? "selected" : ""?> value="0">Không kích hoạt</option>
                    </select>
                  </div>
                </div>
                <!-- /.card-body -->
