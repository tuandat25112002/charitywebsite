            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                 @if ($errors->any())
                        ...
                        @endif
              <form method="POST" action="{{route('manager-news.store')}}"  enctype="multipart/form-data">
                         @csrf
                          <div class="card-body">
                            <div class="form-group">
                            <label for="exampleInputEmail1">Tiêu đề tin tức:</label>
                            <input type="text" class="form-control" name="tieude" id="slug" value="{{old('tieude')}}" onkeyup="ChangeToSlug();" aria-describedby="emailHelp" placeholder="Tiêu đề tin tức...">

                          </div>
                              <div class="form-group">
                            <label for="exampleInputEmail1">Slug tin tức:</label>
                            <input type="text" class="form-control" name="slug_tintuc" id="convert_slug" value="{{old('slug_tintuc')}}" aria-describedby="emailHelp" placeholder="Slug tin tức...">

                          </div>
                          <div class="form-group">
                            <label for="exampleInputEmail1">Tóm tắt tin tức:</label>
                            <input type="text" name="tomtat" class="form-control" id="exampleInputEmail1" value="{{old('tomtat')}}" aria-describedby="emailHelp" placeholder="Tóm tắt tin tức...">

                          </div>
                          <div class="form-group">
                            <label for="exampleInputEmail1">Nội dung tin tức:</label>
                            <textarea class="form-control" id="editor" name="noidung" rows="5" resize="none">{{old('noidung')}}</textarea>
                    ...
                    <img src="{{asset("img/default.png")}}" width="auto" height="300px" id="image">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nguon" value="{{old('nguon')}}"  aria-describedby="emailHelp" placeholder="Nguồn...">
